    ...
    <div>
      {isOpen ? (
        <div className={styles.detailopen}>
          <div className={styles.togglebutton} onClick={() => setIsOpen(false)} role="button">
          ...
          <div className={styles.detail}>{ShowContent({ project, detail })}</div>
        </div>
      ) : (
        <div className={styles.detailclosed}>
          <div className={styles.togglebutton} onClick={() => setIsOpen(true)} role="button">
            <span>{detail[0].toUpperCase() + detail.slice(1)}</span>
            <span>
